...
Random is a project that enables a random number, and comparing if it is greater or less than the value 0.5

This code is run in Nodejs and is written in JavaScript

Descripción
===========
Random es un proyecto que permite obtener un número aleatorio, y comparar si es mayor o menor al valor 0,5

Este codigo se ejecuta en Node js y esta escrito en JavaScript
